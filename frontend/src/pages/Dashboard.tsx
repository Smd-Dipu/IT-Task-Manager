  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <BarChartCard title="Department Performance" data={(data?.deptPerf || []).map((t) => ({ name: t.name, done: t.done }))} xKey="name"
              ...
              return (
                <button key={t.id} onClick={() => navigate(`/tasks/${t.id}`)}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-ink3 truncate">{t.team_name || 'No team'} · {t.department_name || 'No dept'} · updated {timeAgo(t.updated_at)}</div>
                  </div>
